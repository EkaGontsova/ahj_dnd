...
var Card = /*#__PURE__*/function () {
  ...
  return _createClass(Card, [{
    key: "addCard",
    value: function addCard(parentSelector) {
    ...
    key: "clickOnRemoveButton",
    value: function clickOnRemoveButton() {
...
var Form = /*#__PURE__*/function () {
  ...
  return form_createClass(Form, [{
    ...
    key: "render",
    value: function render(previousSelector) {
      var previousElement = document.querySelector(previousSelector);
    ...
    value: function closeForm() {
      ...
      var button = this.element.nextElementSibling;
      button.classList.remove("hidden");
      this.hideTooltip();
    }
  }, {
    key: "clickOnSubmitForm",
    value: function clickOnSubmitForm(event) {
      event.preventDefault();
      var message = this.textarea.value;
      if (!message) {
        this.tooltip.textContent = "Enter a task or close the window";
        this.showTooltip();
        return;
      }
      var cardList = _toConsumableArray(document.querySelectorAll(".cards__item"));
      var beforeAddedCard = cardList.some(function (card) {
        return card.textContent === message;
      });
      if (beforeAddedCard) {
        this.tooltip.textContent = "This task already exists!";
        this.showTooltip();
      } else {
        var card = new Card(message);
        var column = this.element.closest(".column");
        var attribute = column.dataset.title;
        card.addCard("[data-title=\"".concat(attribute, "\"] .cards"));
        this.closeForm();
      }
    }
  }, {
    key: "clickOnCloseForm",
    value: function clickOnCloseForm() {
      this.closeForm();
    }
  }, {
    key: "onInput",
...
;// ./src/js/components/column/column.js
...
function column_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function column_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, column_toPropertyKey(o.key), o); } }
function column_createClass(e, r, t) { return r && column_defineProperties(e.prototype, r), t && column_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function column_toPropertyKey(t) { var i = column_toPrimitive(t, "string"); return "symbol" == column_typeof(i) ? i : i + ""; }
...
var Column = /*#__PURE__*/function () {
  function Column(title, dataAttribute) {
  ...
  return column_createClass(Column, [{
    key: "render",
    value: function render(parentSelector, data) {
      this.parentElement = document.querySelector(parentSelector);
      this.parentElement.append(this.element);
      var attribute = this.element.dataset.title;
      var messages = data[attribute];
      for (var i = 0; i < messages.length; i += 1) {
        var card = new Card(messages[i]);
        card.addCard("[data-title=\"".concat(attribute, "\"] .cards"));
      }
      this.form = new Form();
      this.form.render("[data-title=\"".concat(attribute, "\"] .cards"));
    }
  }, {
    key: "clickOnForm",
    value: function clickOnForm() {
...
;// ./src/js/components/container/container.js
...
;// ./src/js/tasks.js
var tasks = {
  todo: ["Schedule a team meeting", "Draft a project plan", "Prepare a progress report", "Identify priority tasks"],
  in_progress: [
  ...
  done: ["Complete planning for the current project phase", "Conduct a successful meeting", "Document key decisions", "Successfully onboard new team members"]
};
  ...
  return storage_createClass(Storage, [{
    ...
    value: function getStorage() {
      if (!localStorage.getItem("formdata")) {
        this.formData = structuredClone(js_tasks);
      } else {
    ...
    value: function setStorage() {
      ...
      columns.forEach(function (column) {
        var key = column.dataset.title;
        var value = [];
        var cardList = column.querySelectorAll(".cards__item");
...
;// ./src/js/dnd.js
function dnd_typeof(o) { "@babel/helpers - typeof"; return dnd_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, dnd_typeof(o); }
...
function dnd_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function dnd_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, dnd_toPropertyKey(o.key), o); } }
function dnd_createClass(e, r, t) { return r && dnd_defineProperties(e.prototype, r), t && dnd_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function dnd_toPropertyKey(t) { var i = dnd_toPrimitive(t, "string"); return "symbol" == dnd_typeof(i) ? i : i + ""; }
function dnd_toPrimitive(t, r) { if ("object" != dnd_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != dnd_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var DnD = /*#__PURE__*/function () {
  ...
  return dnd_createClass(DnD, [{
    key: "cloneCard",
    value: function cloneCard() {
      this.clone = document.createElement("li");
      this.clone.classList.add("cards__item", "cards__item_cloned");
      this.clone.style.width = "".concat(this.grabbedCard.clientWidth, "px");
      this.clone.style.height = "".concat(this.grabbedCard.clientHeight, "px");
    }
  }, {
    key: "onMouseDown",
    value: function onMouseDown(event) {
      ...
      event.preventDefault();
      var width = this.grabbedCard.clientWidth;
      var height = this.grabbedCard.clientHeight;
      var _this$grabbedCard$get = this.grabbedCard.getBoundingClientRect(),
        top = _this$grabbedCard$get.top,
        left = _this$grabbedCard$get.left;
      ...
      this.grabbedCard.style.width = "".concat(width, "px");
      this.grabbedCard.style.height = "".concat(height, "px");
      this.grabbedCard.style.top = "".concat(top, "px");
      this.grabbedCard.style.left = "".concat(left, "px");
    ...
    value: function onMouseMove(event) {
      event.preventDefault();
      this.grabbedCard.style.top = "".concat(event.pageY - this.mouseY, "px");
      this.grabbedCard.style.left = "".concat(event.pageX - this.mouseX, "px");
      var belowElement = document.elementFromPoint(event.pageX, event.pageY);
      if (!belowElement) {
        return;
      }
      ...
      var target = belowElement.closest(".cards__item");
      if (target) {
